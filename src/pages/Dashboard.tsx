...
export default function Dashboard() {
  ...
  // Check if user is customer or cashier role
  ...
  // Customer and Cashier roles cannot access dashboard
  if (isCustomerRole || isCashierRole) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px]">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Access Denied</h2>
          <p className="text-gray-600">Dashboard is not available for {user?.role} role.</p>
          <p className="text-sm text-gray-500 mt-2">Please navigate to the Transactions page to view your activities.</p>
        </div>
      </div>
    );
  }

  // Original content (now only for admin and manager)
  // Regular dashboard for admin and manager roles only
  return (
